...
public final class VerticalTabLayoutMediator {
    @NonNull private final VerticalTabLayout tabLayout;
    ...
    @Nullable private VerticalTabLayoutOnPageChangeCallback onPageChangeCallback;
    @Nullable private VerticalTabLayout.OnTabSelectedListener onTabSelectedListener;
     ...
     * the provided {@link VerticalTabLayout} so that the tab position is kept in sync.
     *
     ...
     */
    private static class VerticalTabLayoutOnPageChangeCallback
